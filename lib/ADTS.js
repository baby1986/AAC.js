...
var ADTS = {
    ...
    "toBlob":           ADTS_toBlob,            // ADTS.toBlob(source:Uint8Array, adts:ADTSObject = null):Blob
};
...
//}@dev
    ...
    if (AAC["ESTIMATED_DURATION"]) {
        adts = adts || _parseFrames(source, 0, 0);

        var packing = AAC["AAC_44100_LR_2"];
        var length  = ((adts["frames"].length / 2) + 1) | 0;

        switch (adts["audioObjectType"]) {
        case  2: packing = AAC["AAC_44100_LR_2"]; break;
        case  5: packing = AAC["AAC_44100_LR_5"]; break;
        case 29: packing = AAC["AAC_44100_LR_29"]; break;
        }
