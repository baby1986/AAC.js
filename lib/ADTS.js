...
- AudioMetaDataObject
    - https://github.com/uupaa/ADTS.js/wiki/AudioMetaDataObject
- ADTSHeaderObject
...
var ADTS = {
    ...
    "toBlob":       ADTS_toBlob,    // ADTS.toBlob(source:Uint8Array, preBufferLength:UINT8 = 0, postBufferLength:UINT8 = 0):Blob
    "repository":   "https://github.com/uupaa/ADTS.js",
};
...
function ADTS_toBlob(source,             // @arg Uint8Array - ADTS+AAC Stream
                     preBufferLength,    // @arg UINT8 = 0 - pre-extend soundless buffer length.
                     postBufferLength) { // @arg UINT8 = 0 - post-extend soundless buffer length.
                                         // @ret Blob
    var buffer = [];

    for (var i = 0, iz = preBufferLength; i < iz; ++i) {
        buffer.push(SOUNDLESS);
    }

    buffer.push(source);

    for (i = 0, iz = postBufferLength; i < iz; ++i) {
        buffer.push(SOUNDLESS);
    }
