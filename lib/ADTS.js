...
- https://github.com/uupaa/AAC.js/wiki/ADTSFrameObject - { mpegVersion, crcProtection, audioObjectType, samplingRate, channels, adtsFrameBegin, adtsFrameEnd, adtsHeaderLength, rawDataBlockStart, rawDataBlockEnd, bufferFullness, rdbsInFrame, crcLength, error }
- ADTSFrameObject
...
- ADTSObject: { samplingRate, duration, durationString, channels, frames, rawDataBlocks, headerBytes, rawDataBytes, errorBytes, contamination }
    - samplingRate:         UINT32,                 // sampling rate (Sampling frequency)
